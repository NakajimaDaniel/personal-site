  ...
  return (
    <Container maxW="100vw" w="100%" p="0" bg={colorMode === "dark" ? "blue.transparent" : "white.transparent"} position="fixed" top="0" pt="5" pl="5" pb="3" zIndex={20} backdropFilter="saturate(180%) blur(5px)" >
      <Flex align="center">
        ...
        {width >= 655 ? (
          <>
            <Box pr={[15, 15, 19, 20, 20]} _hover={{ color: "#FFE072" }} sx={{ 'transition': '0.3s' }} fontSize={[15, 15, 18]} >
              <Link href="/">Home</Link>
            </Box>
            <Box pr={[15, 15, 19, 20, 20]} _hover={{ color: "#FFE072" }} sx={{ 'transition': '0.3s' }} fontSize={[15, 15, 18]}>
              <Link href="projects">Projects</Link>
            </Box>
            <Box pr={[10, 10, 10, 20, 100]} _hover={{ color: "#FFE072" }} sx={{ 'transition': '0.3s' }} fontSize={[15, 15, 18]}>
