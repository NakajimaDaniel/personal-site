  ...
  return (
    ...
    <Container maxW="100vw" w="100%" mt="20">
      ...
      <SimpleGrid columns={[1,1,1,2]} spacing={10} align="center">
        ...
        <Flex pt="5" direction="column" w={width >= 440 ? "440" : "300"} align="center" >
          <Box w={width >= 440 ? "440" : "300"} >    
            ...
            <Text maxW="440" w="100%" bg={ colorMode === "dark" ? "blue.800" : "white.700" } mt="5" mb="5" pl="2" pr="2" pt="2" pb="2" borderRadius="5" fontSize={width >= 440 ? 17 : 15}> 
